    ...
    <div
        ...
        <div class="card" style="max-width: 450px; width: 100%; text-align: center;">
            ...
            <div style="display: flex; gap: 0.5rem; margin-bottom: 1.5rem; border-bottom: 2px solid #F5F5F5;">
                <button type="button"
                    style="flex: 1; padding: 0.75rem; background: white; border: none; border-bottom: 2px solid #0A0A0A; margin-bottom: -2px; font-weight: 600; cursor: pointer;">Iniciar
                    Sesión</button>
                <a href="{{ route('register') }}"
                    style="flex: 1; padding: 0.75rem; background: white; border: none; color: var(--text-secondary); text-decoration: none; display: block;">Registrarse</a>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" style="text-align: left;">
                ...
                <button type="submit" class="btn btn-primary"
                    style="width: 100%; padding: 0.75rem; font-size: 1rem;">Iniciar Sesión</button>
            </form>
        </div>
    </div>
@endsection